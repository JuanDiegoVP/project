      ...
      <div className="flex items-center gap-2 mr-2">
          ...
          {({ open }) => (
            <>
              ...
              <Transition
                ...
                enterFrom="opacity-0 traslate-y-1"
                enterTo="opacity-100 translate-y-0"
                leave="transition ease-in duration-50"
                leaveFrom="opacity-100 tranlate-y-0"
                leaveTo="opacity-o translate-y-1"
              >
        ...
        <Menu as="div" className="relative">
          <div className="inline-flex">
            <MenuButton className="ml-2 inline-flex rounded-full focus:outline-none focus:ring-2 focus:ring-neutral-400">
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://images.pexels.com/photos/12116143/pexels-photo-12116143.jpeg?auto=compress&cs=tinysrgb&w=400')",
                }}
              >
          ...
          <Transition
            ...
            enterFrom="transform opacity-8 scale-95"
